...
const RestaurantCard =({name,locality,cloudinaryImageId,cuisines,avgRating,deliveryTime,costForTwoString,id})=>{
    return(
        ...
        <div className="w-80 border border-gray-200 rounded-md overflow-hidden cursor-pointer">
            ...
            <div className='p-2'>
                ...
                <div className='mt-2 text-sm flex justify-between text-gray-700'>
                    <span className='bg-green-600 text-white p-1 '>&#9733; {avgRating}</span>|
